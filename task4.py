...
if __name__ == '__main__':
    ...
    # Define data augmentation transforms: random horizontal flip and rotation
    ...
    for epoch in range(1, 4):
        ...
        for i, (images, labels) in tqdm(enumerate(trainloader), total=len(trainloader), leave=False):
            ...
            # Apply random horizontal flip and rotation transforms to images
        ...
        plt.ylabel('Loss')
        plt.legend()
        plt.savefig('lab8/task4_loss_plot.png')